...
## How to run it
You can check how to run this project in [exec_instructions.md](https://github.com/CLopMan/University_Projects/blob/main/FinalProject-FirstYear/exec_instructions.md)
